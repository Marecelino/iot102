/*
    IOT102 PT1 - Smart Lock
    Thực hiện: IOT102_3W_01 - Nhóm 9
        - Nguyễn Viết Phong
        - Nguyễn Trọng Thứ
        - Nguyễn Thị Yến Vy
*/
...
/* Notes:
    - Mật khẩu mặc định 1: 0000 - Lưu ở ô nhớ số 10
...
int defaultPassword1 = 0000;
int defaultPassword2 = 9999;
const String UIDMaster = "c6e7b789";
String secondUID;
